...
def target(rot1,pos1,width1,length1,r1,g1,b1,rot2,pos2,width2,length2,r2,g2,b2,rot3,pos3,width3,length3,r3,g3,b3,rot4,pos4,width4,length4,r4,g4,b4):
    ...
    sys.stdout.write("rot3=%.2f,pos3=%.2f,width3=%.2f,length3=%.2f,r3=%.2f,g3=%.2f,b3=%.2f,"%(rot3,pos3,width3,length3,r3,g3,b3))
    sys.stdout.write("rot4=%.2f,pos4=%.2f,width4=%.2f,length4=%.2f,r4=%.2f,g4=%.2f,b4=%.2f,"%(rot4,pos4,width4,length4,r4,g4,b4))

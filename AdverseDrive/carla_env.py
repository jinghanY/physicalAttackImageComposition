...
class CarlaEnv:
    def __init__(self, town='Town01_nemesisA',
                task='turn-right', weather='ClearNoon',
                port=2000, save_images=False, gpu_num=0,
                experiment_name='baseline',adversary_name="adversary_",intersection="42_47"):
        """
        ...
        self.experiment_suite = AdversarySuite(self.town, self.task,
                            self.weather, self.iterations, self.intersection)
    ...
    def step(self, adversary_parameters):
        ...
        self.adversary.draw_lines(adversary_parameters)

...
def target(rot1,pos1,width1,length1,r1,g1,b1,rot2,pos2,width2,length2,r2,g2,b2,rot3,pos3,width3,length3,r3,g3,b3,rot4,pos4,width4,length4,r4,g4,b4,rot5,pos5,width5,length5,r5,g5,b5):
    ...
    numbers[adversary_name]['rot'] = float(rot3)
    numbers[adversary_name]['pos'] = float(pos3)
    numbers[adversary_name]['length'] = float(length3)
    numbers[adversary_name]['width'] = float(width3)
    numbers[adversary_name]['r'] = float(r3)
    numbers[adversary_name]['g'] = float(g3)
    numbers[adversary_name]['b'] = float(b3)
    
    adversary_name = "rectangle4"
    numbers[adversary_name] = {}
    numbers[adversary_name]['rot'] = 0
    numbers[adversary_name]['pos'] = 88
    numbers[adversary_name]['length'] = 40
    ...
    numbers[adversary_name]['rot'] = float(rot4)
    numbers[adversary_name]['pos'] = float(pos4)
    numbers[adversary_name]['length'] = float(length4)
    numbers[adversary_name]['width'] = float(width4)
    numbers[adversary_name]['r'] = float(r4)
    numbers[adversary_name]['g'] = float(g4)
    numbers[adversary_name]['b'] = float(b4)
    
    adversary_name = "rectangle5"
    numbers[adversary_name] = {}
    numbers[adversary_name]['rot'] = 0
    numbers[adversary_name]['pos'] = 88
    numbers[adversary_name]['length'] = 40
    ...
    numbers[adversary_name]['rot'] = float(rot5)
    numbers[adversary_name]['pos'] = float(pos5)
    numbers[adversary_name]['length'] = float(length5)
    numbers[adversary_name]['width'] = float(width5)
    numbers[adversary_name]['r'] = float(r5)
    numbers[adversary_name]['g'] = float(g5)
    numbers[adversary_name]['b'] = float(b5)
    ...
    sys.stdout.write("rot1=%.2f,pos1=%.2f,width1=%.2f,length1=%.2f,r1=%.2f,g1=%.2f,b1=%.2f,rot2=%.2f,pos2=%.2f,width2=%.2f,length2=%.2f,r2=%.2f,g2=%.2f,b2=%.2f,rot3=%.2f,pos3=%.2f,width3=%.2f,length3=%.2f,r3=%.2f,g3=%.2f,b3=%.2f,rot4=%.2f,pos4=%.2f,width4=%.2f,length4=%.2f,r4=%.2f,g4=%.2f,b4=%.2f,rot5=%.2f,pos5=%.2f,width5=%.2f,length5=%.2f,r5=%.2f,g5=%.2f,b5=%.2f,target=%.2f\n"%(rot1,pos1,width1,length1,r1,g1,b1,rot2,pos2,width2,length2,r2,g2,b2,rot3,pos3,width3,length3,r3,g3,b3,rot4,pos4,width4,length4,r4,g4,b4,rot5,pos5,width5,length5,r5,g5,b5,diff))
    sys.stdout.flush()
    return diff

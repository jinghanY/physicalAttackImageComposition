...
def target(rot1,pos1,width1,length1,r1,g1,b1):
    ...
    numbers[adversary_name]['length'] = 10
    numbers[adversary_name]['width'] = 40
    ...
    sys.stdout.write("rot1=%.2f,pos1=%.2f,width1=%.2f,length1=%.2f,r1=%.2f,g1=%.2f,b1=%.2f,target=%.2f\n"%(rot1,pos1,width1,length1,r1,g1,b1,diff))
    sys.stdout.flush()
    return diff

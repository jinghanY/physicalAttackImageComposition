...
def para_gen(para_name,random_seed_para_gen,step_size):
	if para_name.startswith("rot"):
		...
		return [parameter_one_randomGen(0,255,random_seed_para_gen),255.0,step_size]
...
class ImitationLearningInit():
    ...
    def __init__(self, paras_dict, epoch, random_seed, step_size,memory_fraction=0.25, image_cut=[115, 510],LR=0.1,task='right-turn/',intersection="42_47/"):
        ...
        self.dataset_rt_clean = "../../datasets/"
        self.dataset_rt_noises = "../../datasets/"

...
def write_config(intersection_path, task, intersection, adversary,num,LR,step,randomSeed,step_size1,step_size2,step_size3):
...
paras = ["rot","pos","width","length","r","g","b"]
...
for adversary_name in names:
	...
	for j in range(len(paras)):
		...
		if count in no_paras: 
			write_config(intersection_path, task, intersection, adversaries, count, LR, step, randomSeed,step_size1,step_size2,step_size3)
			count2 += 1
		count += 1
...
#code_intersection = "46_39_2/"
script_name = "imitation_fly_auto_continue4/run.py" 

gpuJob_pt = "cpuJobs_"+str(no_paras_num)+"/"

...
class DrivingBenchmark(object):
    ...
    def _run_navigation_episode(
        ...
        while (current_timestamp - initial_timestamp) < (time_out * 1500) and not success:
            ...
            control = agent.run_step(measurements, sensor_data, directions, target, self._episode_number)

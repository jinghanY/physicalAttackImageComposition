...
class ExperimentSuite_test(object):

    def __init__(self, city_name, task, weather, iters, intersection, num_vehicle, num_pedestrian, seed_vehicle, seed_pedestrian):
        ...
        self._num_vehicle = num_vehicle
        self._num_pedestrian = num_pedestrian
        self._seed_vehicle = seed_vehicle
        self._seed_pedestrian = seed_pedestrian

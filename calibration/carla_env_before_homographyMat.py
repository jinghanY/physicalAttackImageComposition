...
from imitation_before_homographyMat.imitation_learning import ImitationLearning
...
class CarlaEnv:
    ...
    def step(self):
        ...
        self.agent = ImitationLearning(self.town, self.task, self.intersection, self.save_choice,self.avoid_stopping,trajectory_no=self.trajectory_no,opt=self.opt,min_frames=self.min_frames,max_frames=self.max_frames)

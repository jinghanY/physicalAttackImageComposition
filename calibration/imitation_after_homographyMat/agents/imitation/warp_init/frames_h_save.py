...
file_initialPoints_pt = "/home/jinghan/Documents/auto_adv/carla-cluster/PythonClient-cluster/adversary_data/Town01_nemesis/single-line/initial_points.txt"

angle_range = [2,3]

im_src_pt= "/home/jinghan/Documents/auto_adv/carla-cluster/PythonClient-cluster/adversary_data/Town01_nemesis/single-line/source.png"
...
im_src = im_src[10:79,100:111,:]+0.6
...
for i in tqdm(range(len(framesNumbers))):
	...
	frame_this = Frame(frameNum, pointsAmount,file_initialPoints_pt,points_frames_path,angle_range)

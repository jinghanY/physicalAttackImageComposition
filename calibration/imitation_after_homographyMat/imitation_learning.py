...
class ImitationLearning(Agent):
    ...
    def __init__(self, city_name, task, intersection, save_choice,avoid_stopping, min_frames, max_frames, trajectory_no, memory_fraction=0.25, image_cut=[115, 510],opt=0):
    ...
    def _compute_action(self, rgb_image, speed, direction=None):
        ...
        steer_dict_file = self.steer_deviation_clean_pt + str(self.frame_count)+".pickle"
